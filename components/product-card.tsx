        ...
        <div className="flex-grow flex flex-col justify-between py-1">
          ...
          <div className="flex items-center justify-between w-full gap-2 mt-2">
            {quantity > 0 ? (
              ...
              <Button variant="outline" size="default" onClick={() => onQuantityChange(1)} className="h-10 px-3">
            ...
            <div className="flex gap-1">
              ...
              <Button variant="outline" size="default" onClick={() => onQuantityChange(5)} className="h-10 px-3">
                +5
              </Button>
              <Button variant="outline" size="default" onClick={() => onQuantityChange(10)} className="h-10 px-3">
                +10
              </Button>
            </div>
          </div>
